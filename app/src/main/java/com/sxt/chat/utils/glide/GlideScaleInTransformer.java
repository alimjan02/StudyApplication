...
public class GlideScaleInTransformer implements ViewPager.PageTransformer {
    ...
    public GlideScaleInTransformer() {

    }

    public GlideScaleInTransformer(ViewPager.PageTransformer pageTransformer) {
        this(DEFAULT_MIN_SCALE, pageTransformer);
    }


    public GlideScaleInTransformer(float minScale, ViewPager.PageTransformer pageTransformer) {
        mMinScale = minScale;
