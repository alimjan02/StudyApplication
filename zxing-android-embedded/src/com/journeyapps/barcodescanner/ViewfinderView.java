...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        textPaint.setTextSize(dip2px(18));
    ...
    private void init(Canvas canvas) {
        ...
        previewFrame = cameraPreview.getPreviewFramingRect();
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {//画扫描边框
            paint.setAlpha(CURRENT_POINT_OPACITY);
            canvas.drawBitmap(resultBitmap, null, frame, paint);
            canvas.drawText("将二维码放入框内", width / 2, frame.bottom + dip2px(30), textPaint);
        } else {
        ...
        if (laserBitmap != null) {//画扫描的激光线
            if (currentRect == null) {
                currentRect = new Rect(frame.left, frame.top, frame.right, frame.top + 10);
            } else {
                currentRect.top += 10;
                currentRect.bottom = currentRect.top + 10;
            }

            if (currentRect.top > frame.bottom - 10 || currentRect.bottom > frame.bottom - 10) {
                currentRect = new Rect(frame.left, frame.top, frame.right, frame.top + 10);
            }
            canvas.drawBitmap(laserBitmap, null, currentRect, paint);
    ...
    public void drawLaserBitmap(Bitmap laser) {
        laserBitmap = laser;
        invalidate();
    }
