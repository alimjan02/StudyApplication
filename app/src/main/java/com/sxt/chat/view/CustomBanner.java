...
import com.sxt.banner.BannerScroller;
import com.sxt.banner.WeakHandler;
import com.sxt.banner.listener.OnBannerClickListener;
import com.sxt.banner.listener.OnBannerListener;
import com.sxt.banner.loader.ImageLoaderInterface;
...
public class CustomBanner extends FrameLayout implements OnPageChangeListener {
    ...
    public CustomBanner setPageMargin(int pageMargin) {
        if (viewPager != null) {
    ...
    public CustomBanner setViewPagerMargins(int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
        if (viewPager != null) {
    ...
    public CustomBanner setChi(boolean clipChildren) {
        if (viewPager != null) {
