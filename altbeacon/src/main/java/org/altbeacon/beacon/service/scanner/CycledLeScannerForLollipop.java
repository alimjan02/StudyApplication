        ...
        if (leScanCallback == null) {
            leScanCallback = new ScanCallback() {
                ...
                public void onScanFailed(int i) {
                    if(!isScanFailed){
                        LogManager.e(TAG, "Scan Failed" +" errorCode"+i);
                        OnFailScanCallback onFailScanCallback=   mBeaconManager.getOnFailScanCallback();
                        if (onFailScanCallback!=null){
                            isScanFailed=true;
                            onFailScanCallback.onScanFailed(i);
                        }
                    }
